...
from app.api import audit, decisions, events, inventory, messages, production_orders, security, suppliers, ws_routes
...
app = FastAPI(title="SENTINEL — Autonomous Supply Chain & Trust Fabric", lifespan=lifespan)
